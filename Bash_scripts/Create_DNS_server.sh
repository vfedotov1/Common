...
tee /var/named/master/home.local.ru << EOF
\$TTL 3600         ;
home.local.ru.    IN      SOA     db1.home.local.ru. root.home.local.ru. (
                  1               ; Serial
                  600             ; Refresh
                  3600            ; Retry
                  1w              ; Expire
          ...
          IN      NS      db1.home.local.ru.
          IN      A       192.168.0.20
db1       IN      A       192.168.0.20
...
nslookup yandex.ru 192.168.0.20
...
tee /var/named/master/0.168.192.zone << EOF
\$TTL 3600         ;
@         IN      SOA     db1.home.local.ru. root.home.local.ru. (
                  1               ; Serial
                  600             ; Refresh
                  3600            ; Retry
                  1w              ; Expire
...
@         IN      NS      db1.home.local.ru.
20        IN      PTR     db1.home.local.ru.
21        IN      PTR     db2.home.local.ru.
EOF
...
nslookup 192.168.0.20 192.168.0.20
